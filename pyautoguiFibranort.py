...
proxmox_url = "https://143.137.163.1:65050/"
...
# Clicar em OK
clicar_em_imagem('./abenet/botao_ok.png', tempo_espera=3) or pyautogui.click(940, 599)
...
logar_console_maquina((114,499))

# Fechar o console da Máquina 1
fechar_terminal((1266, 15))

# Acessar e desbloquear a Máquina 2
logar_console_maquina((114, 521))
